// Pure computation functions for the Consensus Engine intelligence layer.
// These derive narrative and explainability from data already in scope —
// no network calls, no mock imports.

import type { ConsensusState, Bias, MarketStructure, ConsensusHistoryPoint } from '@/types/consensus'
import type { Market } from '@/types/market'
import type { RecommendationOutput } from '@/lib/realtime/types'
import type { IntelligenceSummary, ExplainDriver, ConfidencePoint, ConsensusSnapshot } from '@/types/intelligence'
...
export function getHistoricalSnapshotsFromHistory(hist: ConsensusHistoryPoint[]): ConsensusSnapshot[] {
